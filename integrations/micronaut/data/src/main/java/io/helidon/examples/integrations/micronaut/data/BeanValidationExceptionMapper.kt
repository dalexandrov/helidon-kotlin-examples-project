...
/**
 * A JAX-RS provider that maps [javax.validation.ConstraintViolationException] from bean validation
 * to a proper JAX-RS response with [javax.ws.rs.core.Response.Status.BAD_REQUEST] status.
