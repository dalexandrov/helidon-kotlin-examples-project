...
abstract class DbPetRepository : PageableRepository<Pet?, UUID?> {
    /**
     * Get all pets.
     *
     ...
     * @return list of pets
     */
    abstract fun list(pageable: Pageable?): List<NameDTO?>?
     ...
     */
    @Join("owner")
    abstract fun findByName(name: String?): Optional<Pet?>?
}