...
import io.helidon.kotlin.config.examples.mapping.BuilderExample.AppConfig.Builder
...
object BuilderExample {
    ...
    basicRange= $basicRange"""
        ...
        /**
         * [AppConfig] Builder used to be initialized from configuration.
         */
        class Builder {
            ...
            /**
             * Creates new instance of [AppConfig] using values provided by configuration.
             *
