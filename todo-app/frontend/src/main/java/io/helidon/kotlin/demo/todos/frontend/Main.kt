...
object Main {
     ...
     */
    private fun createRouting(security: Security,
                              config: Config,
                              bsc: BackendServiceClient): Routing {
        return Routing.builder()
                ...
                .register(StaticContentSupport.builder("/WEB").welcomeFileName("index.html")) // register API handler (on "/api") - this path is secured (see application.yaml)
     ...
     */
    private fun started(webServer:WebServer,
                        throwable: Throwable?) {
        if (throwable == null) {
        ...
        return Config.builder()
                .sources(listOf(
                        ...
                        ConfigSources.file("prod.yaml")
                                .pollingStrategy(PollingStrategies.regular(
