 ...
 */
class AtzProviderSync : SynchronousProvider(), AuthorizationProvider {
    public override fun syncAuthorize(providerRequest: ProviderRequest): AuthorizationResponse {
        ...
        return providerRequest.env().path()
                .map { path: String ->
                    ...
                    if (providerRequest.securityContext().isAuthenticated) {
                        ...
                        return@map AuthorizationResponse.deny()
                    }
